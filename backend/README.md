...
## Project Structure
    ...
    ├── testapiautoteammem_104219  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammem_104219`
...
2. Clone this repo and `cd testapiautoteammem_104219`
